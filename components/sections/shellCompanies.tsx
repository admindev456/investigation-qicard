      ...
      <div className="mb-10 p-4 sm:p-6 bg-white border-2 border-slate-300 rounded-xl shadow-sm">
        ...
        <div className="mb-6 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg">
          <h4 className="text-sm font-bold text-amber-800 mb-2 flex items-center gap-2">
            ...
            Key Connection: Qi Card Executive Link
          </h4>
          <p className="text-xs sm:text-sm text-amber-900 leading-relaxed">
            The Managing Director is <strong>Mohammed Zuhdi Abdulhadi</strong> — <strong>Chief Cyber Security Officer for QiCard</strong> and a <strong>close executive</strong> to <strong>Bahaa Abdul Hussein Abdul Hadi</strong>, the founder and chairman of Qi Card. While the shared surname &quot;Abdulhadi&quot; initially suggested a family connection, Mohammed Zuhdi is actually a senior executive serving as the operational front for this shell company.
          </p>
        </div>
